...
print(countdown)(5)
#Example: countdown(5) s hould return [5,4,3,2,1,0]
...
#Example: first_plus_length([1,2,3,4,5])) should return 6 ( first value: 1 + legnth: 5)
...
#Example:length_and_value(6,2) should return [2,2,2,2,2]